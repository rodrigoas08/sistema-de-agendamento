...
export default function LoginForm() {
	...
	return (
		<div className="flex flex-col items-center">
			<Link
				href="/"
				className="self-start flex items-center gap-2 text-white hover:text-white/50 transition-colors mb-6 text-sm font-semibold"
			>
				...
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-6 flex flex-col">
					...
					<div className="w-full flex flex-col items-end">
						<button
							type="submit"
							disabled={isLoading}
							className="flex items-center justify-center w-full mt-4 py-4 text-white font-bold bg-red-500 hover:bg-red-600 disabled:bg-red-300 rounded transition-colors tracking-wide cursor-pointer"
						>
							{isLoading ? (
